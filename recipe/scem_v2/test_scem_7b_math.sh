...
ray job submit --runtime-env="${RUNTIME_ENV}" \
    ...
    -- python3 -m recipe.scem_v2.main_scem \
    ...
    trainer.validation_data_dir="${CKPTS_DIR}/val_output" \
    trainer.rollout_data_dir="${CKPTS_DIR}/train_output" \
    +algorithm.scem.lambda_entropy=0.1 \
    +algorithm.scem.entropy_threshold=1.0 \